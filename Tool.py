...
██║░░██║╚██████╔╝░░░██║░░░  ██████╔╝╚██████╔╝██║░░░░░███████╗██║░░██║
╚═╝░░╚═╝░╚═════╝░░░░╚═╝░░░  ╚═════╝░░╚═════╝░╚═╝░░░░░╚══════╝╚═╝░░╚═╝ [{Color.LG}>
    {Color.LR}[{Color.LG}>     Made with ☕ By Huy Sufer    {Color.LG}<{Color.LR}]""")
		print(Color.LC+"    Type "+Color.LB+"'HELP'"+Color.LC+" to see all commands\n\n")
		print(Color.LR+"["+Color.LG+"1"+Color.LR+"]"+Color.LC+" Proxy")
		print(Color.LR+"["+Color.LG+"2"+Color.LR+"]"+Color.LC+" WebTool")
		print(Color.LR+"["+Color.LG+"3"+Color.LR+"]"+Color.LC+" L4/L7/BBoS")
		print(Color.LR+"["+Color.LG+"4"+Color.LR+"]"+Color.LC+" SpeedTest")
		print("\n")
		while True:
			try:
				sys.stdout.write(Color.LB+"╔═══"+Color.LR+"["+Color.LG+"HUYSUFERv2"+Color.LB+"@"+Color.LG+"Home"+Color.LR+"]"+Color.LB+"\n╚══> "+Color.RESET)
				option = input()
				if option == '01' or option == '1':
					...
					subprocess.run(['pkill -f HUYSUFER.py'], shell=True)
...
""")
		...
		print("\n")
		while True:
				sys.stdout.write(Color.LB+"╔═══"+Color.LR+"["+Color.LG+"HUYSUFERv2"+Color.LB+"@"+Color.LG+"Proxy"+Color.LR+"]"+Color.LB+"\n╚══> "+Color.RESET)
				option = input()
				if option == '01' or option == '1':
...
""")
		...
		print("\n")
		while True:
			sys.stdout.write(Color.LB+"╔═══"+Color.LR+"["+Color.LG+"HUYSUFERv2"+Color.LB+"@"+Color.LG+"Webtool"+Color.LR+"]"+Color.LB+"\n╚══> "+Color.RESET)
			option = input()
			if option == '01' or option == '1':
				while True:
...
""")
	...
	def bbos(self):
		...
		print("\n")
		while True:
			sys.stdout.write(Color.LB+"╔═══"+Color.LR+"["+Color.LG+"HUYSUFERv2"+Color.LB+"@"+Color.LG+"L4/L7/BBoS"+Color.LR+"]"+Color.LB+"\n╚══> "+Color.RESET)
			option = input()
			if option == '01' or option == '1':
...
""")
		...
		print("\n")
		while True:
			sys.stdout.write(Color.LB+"╔═══"+Color.LR+"["+Color.LG+"HUYSUFERv2"+Color.LB+"@"+Color.LG+"Layer4"+Color.LR+"]"+Color.LB+"\n╚══> "+Color.RESET)
			option = input()
			if option == '01' or option == '1':
				try:
...
""")
		...
		while True:
			sys.stdout.write(Color.LB+"╔═══"+Color.LR+"["+Color.LG+"HUYSUFERv2"+Color.LB+"@"+Color.LG+"Layer7"+Color.LR+"]"+Color.LB+"\n╚══> "+Color.RESET)
			option = input()
			if option == '01' or option == '1':
				try:
...
{Color.LC}DEV{Color.LR} ~> {Color.LY}Contact/Support dev"""
	dev = f"""{Color.LC}ZALO{Color.LR}: {Color.LY}https://zalo.me/84393661180
"""
